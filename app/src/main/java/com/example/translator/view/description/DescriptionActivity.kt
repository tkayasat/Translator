...
class DescriptionActivity : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        binding.descriptionSwipeRefreshLayout.setOnRefreshListener { startLoadingOrShowError() }
        setData()
    }
    ...
    private fun setData() {
        ...
        binding.descriptionText.text = bundle?.getString(DESCRIPTION_EXTRA)
        val imageLink = bundle?.getString(URL_EXTRA)
        if (imageLink.isNullOrBlank()) {
            stopRefreshAnimationIfNeeded()
        } else {
            usePicassoToLoadPhoto(binding.descriptionImage, imageLink)
        }
    }
    ...
    private fun stopRefreshAnimationIfNeeded() {
        if (binding.descriptionSwipeRefreshLayout.isRefreshing) {
            binding.descriptionSwipeRefreshLayout.isRefreshing = false
        }
    }
